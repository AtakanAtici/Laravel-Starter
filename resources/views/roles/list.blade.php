                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                                @foreach($role->users as $user)
                                    ...
                                    >
                                        <img class="rounded-circle" src="../../assets/img/default-avatar.png" alt="Avatar" />
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="d-flex justify-content-between align-items-end">
                            ...
                            @can('delete_roles')
                                <a href="javascript:void(0);" class="text-muted" data-bs-toggle="modal" data-bs-target="#removeModal-{{$role->id}}">
