            ...
            <div id="DataTables_Tabe_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <table class="datatables-users table border-top dataTable no-footer dtr-column" id="DataTables_Table_0" >
                    ...
                    <tr>
                        ...
                        <th class="sorting sorting_desc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"  colspan="1" aria-label="Role: activate to sort column ascending"  aria-sort="descending">
                            Rol
                        </th>
                        ...
                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 145px;" aria-label="Actions"></th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($users as $user)
                        <tr>
                                ...
                                <div class="d-flex justify-content-start align-items-center user-name">
                                    <div class="avatar-wrapper">
                                        <div class="avatar avatar-sm me-3">
                                            <img src="../../assets/img/default-avatar.png" alt="Avatar" class="rounded-circle"></div>
                                    </div>
                            ...
                            <td><span class="badge bg-label-{{$user->status_color}}">{{$user->status_text}}</span></td>
                            <td><span class="fw-medium">{{\Carbon\Carbon::parse($user->created_at)->format('d.m.Y')}}</span></td>
                            <td>
                                <div class="d-inline-block text-nowrap">
                                    @can('edit_users')
                                        <button data-bs-toggle="modal" data-bs-target="#editModal-{{$user->id}}" class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></button>
                                    @endcan
                                    @can('delete_users')
                                    <button data-bs-toggle="modal" data-bs-target="#removeModal-{{$user->id}}" class="btn btn-sm btn-icon delete-record"><i class="bx bx-trash"></i></button>
                                        @endcan
                                </div>
                            </td>
                        </tr>
